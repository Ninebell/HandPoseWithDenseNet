...
if __name__ == "__main__":
    ...
    if is_train:
        train_model(500, net, custom_loss, optim,
                {'loader': data_load_from_hdf5,
                 'conf': {'hdf5': train_hf, 'batch_size': batch_size, 'is_train': True}
                 },
                {'loader': data_load_from_hdf5,
                 'conf': {'hdf5': validate_hf, 'batch_size': batch_size, 'is_train': True}
                 },
                save_path, 'test', check_point, accuracy=[
